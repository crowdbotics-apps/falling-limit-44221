"""
Django settings for falling_limit_44221 project.
...
ROOT_URLCONF = 'falling_limit_44221.urls'
...
WSGI_APPLICATION = 'falling_limit_44221.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_limit_44221 API",
    "DESCRIPTION": "API documentation for falling_limit_44221 App",
    "VERSION": "v1",
}
